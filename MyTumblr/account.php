        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/sosa.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">Reading Wattpad</p>
                    <p class="font-italic mb-0">Watching Movies</p>
                    <p class="font-italic mb-0">Listening to Music</p>
                </div>
            </div>
